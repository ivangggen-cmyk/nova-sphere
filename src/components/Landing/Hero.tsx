    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden gradient-hero noise">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <motion.div
          ...
          style={{ background: "radial-gradient(circle, hsl(252 85% 60% / 0.12), transparent 70%)" }}
        ...
        <motion.div
          ...
          style={{ background: "radial-gradient(circle, hsl(195 90% 50% / 0.05), transparent 70%)" }}
        ...
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(hsl(252 85% 60%) 1px, transparent 1px), linear-gradient(90deg, hsl(252 85% 60%) 1px, transparent 1px)`,
        ...
        {[600, 800, 1000].map((size, i) => (
          <motion.div
            ...
            style={{ width: size, height: size, borderColor: `hsl(252 85% 60% / ${0.05 - i * 0.012})` }}
      ...
      <div className="relative container mx-auto px-4 pt-24 pb-16">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-white/70">Платформа нового поколения</span>
          ...
          <motion.p
            ...
            className="text-base md:text-xl text-white/45 max-w-2xl mx-auto mb-12 leading-relaxed"
          >
          ...
          >
            <Link to="/auth">
              <Button
                size="lg"
                className="gradient-accent text-primary-foreground border-0 text-base px-10 h-14 rounded-2xl shadow-glow animate-pulse-glow font-semibold"
              >
