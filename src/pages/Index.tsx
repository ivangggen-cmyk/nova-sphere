    ...
    <div className="container mx-auto px-4 relative">
      <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-3xl mx-auto text-center">
        <h2 className="text-3xl md:text-5xl font-display font-bold mb-6 text-balance">
          Готовы начать{" "}<span className="gradient-text">зарабатывать?</span>
        </h2>
        <p className="text-muted-foreground text-lg mb-10 max-w-xl mx-auto">Присоединяйтесь к нашим исполнителям и получите доступ к оплачиваемым заданиям уже сегодня</p>
        <Link to="/auth">
