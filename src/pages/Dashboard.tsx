  ...
  return (
    <DashboardLayout>
      ...
      <motion.div
        ...
        className="bg-card border border-border rounded-2xl p-5 mb-8 relative overflow-hidden"
      >
        ...
        <div className="relative flex items-center justify-between mb-3">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-display font-semibold text-sm">{level}</h3>
              <p className="text-xs text-muted-foreground">Прогресс уровня</p>
            </div>
          </div>
              ...
              {recentTasks.map((ut, i) => (
                ...
                >
                  <Link
                    ...
                    className="flex items-center justify-between p-3 rounded-xl hover:bg-muted/50 transition-all duration-200 group"
                  >
                    ...
                    <div className="flex items-center gap-2 ml-3">
                      <span className={`text-[11px] px-2 py-0.5 rounded-lg font-medium ${statusMap[ut.status]?.cls || ""}`}>
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            {notifications.length > 0 && (
              <span className="text-[11px] px-2 py-0.5 rounded-lg bg-primary/10 text-primary font-medium">
          ...
          {notifications.length === 0 ? (
            <div className="text-center py-10">
              ...
              <p className="text-muted-foreground text-sm">Нет новых</p>
            </div>
          ) : (
